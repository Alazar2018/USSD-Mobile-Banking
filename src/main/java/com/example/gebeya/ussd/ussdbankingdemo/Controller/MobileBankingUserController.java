...
public class MobileBankingUserController {
    ...
    public ResponseEntity<?> createAccountForCustomer(@PathVariable int cif, @RequestBody MobileBankingUser mobileBankingUser) {
 ...
 public ResponseEntity<?> getAccountByCif(@PathVariable String account) {
     try {
         ...
         ErrorResponse errorResponse = new ErrorResponse("Customer not found for account: " + account);
